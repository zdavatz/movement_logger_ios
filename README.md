...
- **Composite export** — single tap produces an H.264 `.mov` with the source video on top and the four panels stacked below, cursor sweeps and GPS dot animated against the video clock. Saves to `Documents/combined_<basename>.mov` and adds to Photos.
